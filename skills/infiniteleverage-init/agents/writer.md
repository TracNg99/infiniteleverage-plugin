...
Check for `context/strategy.md` in the current project.
If not found, do not start writing. Instead, tell the user:
> "No marketing strategy found for this project. Run `/marketing-strategist` first — it turns your client interview or brief into `context/strategy.md`, `context/content-process.md`, and `context/content-calendar.md` which I need before writing."
Then stop and wait.
